...
const UploadPage = () => {
  const img = JSON.parse(localStorage.getItem('userinfo'))?.userInfo?.picture;
  console.log(img)
      ...
      <div className="bg-gray-50_01 flex flex-col font-nunito items-center justify-end mx-auto sm:pr-5 pr-[30px] w-full">
        <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col font-figtree md:gap-10 gap-[137px] items-center justify-start md:mt-0 mt-[49px] w-full">
            <div className="flex md:flex-col flex-row md:pr-0 pr-10 gap-[34px] items-start justify-between w-full">
              ...
              <div className="flex md:flex-1 flex-row gap-[20px] items-center justify-between md:mt-0 w-[15%] md:w-full">
              <button onClick={handleLogout} className=" bg-blue-600 py-3 px-2 rounded text-white-A700_01">
                logout
              </button>
                <div className="flex flex-row gap-4 h-[30px] items-center justify-start w-[30px]">
                <Img
                  className="h-[23px]"
                ...
                />
                  <Img
                    ...
                    src={img ? img : "images/img_image1.png"}
                    alt="imageOne"
                  />
                </div>
              </div>
